...
pub fn decode(
    ...
    let (op_str, p1_str, p2_str): (&str, String, String) = match op[0] {
        ...
        PRTC_VAL => ("PRTC", decode_num(op[1]), String::new()),
        PRTC_REG => ("PRTC", decode_reg(op[1]), String::new()),
        ...
        FCHK_AREG => ("FCHK", decode_reg(op[1]), String::new()),
        FCHK_ADDR => ("FCHK", decode_addr(op[1], op[2]), String::new()),
        IPOLL_AREG => ("IPOLL", decode_reg(op[1]), String::new()),
        IPOLL_ADDR => ("IPOLL", decode_addr(op[1], op[2]), String::new()),
        RSTR_AREG => ("RSTR", decode_reg(op[1]), String::new()),
        RSTR_ADDR => ("RSTR", decode_addr(op[1], op[2]), String::new()),
        PSTR_AREG => ("PSTR", decode_reg(op[1]), String::new()),
        PSTR_ADDR => ("PSTR", decode_addr(op[1], op[2]), String::new()),
        RCHR_REG => ("RCHR", decode_reg(op[1]), String::new()),
